...
export default function CarCard({
  ...
  if (view === "list") {
    return (
      <Link href={`/inventory/${car.id}`} className="block">
        <div className="flex flex-col md:flex-row bg-brand-white border border-brand-border rounded-xl overflow-hidden hover:shadow-lg transition-all duration-300 cursor-pointer group h-full">
          ...
          <div className="p-6 flex flex-col justify-between w-full">
            <div>
              <h3 className="text-xl font-heading font-semibold text-brand-graphite group-hover:text-brand-silver transition-colors">
            ...
            <div className="flex justify-between items-end mt-6">
              ...
              <Button size="sm" className="pointer-events-none">View Details</Button>
            </div>
          </div>
        </div>
      </Link>
  ...
  return (
    <Link href={`/inventory/${car.id}`} className="block">
      <div className="flex flex-col bg-brand-white border border-brand-border rounded-xl overflow-hidden hover:shadow-lg transition-all duration-300 group h-full cursor-pointer">
        ...
        <div className="p-5 flex flex-col flex-grow">
          ...
          <div className="mt-auto flex justify-between items-center">
            ...
            <Button variant="outline" size="sm" className="text-xs px-4 pointer-events-none">
              Details
            </Button>
          </div>
        </div>
