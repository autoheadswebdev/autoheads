...
export default function VehicleDetailsClient({ car }: VehicleDetailsProps) {
            ...
            <div className="bg-brand-white p-4 rounded-2xl border border-brand-border shadow-sm">
              <div className="relative aspect-video rounded-xl overflow-hidden mb-4 group bg-brand-light-grey">
                {car.images.length > 0 ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center text-brand-silver bg-[#111111]/5">No Image Available</div>
                )}
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-brand-white border border-brand-border p-6 rounded-2xl flex flex-col items-center justify-center text-center gap-3 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div>
                  ...
                  <div className="font-heading font-semibold text-brand-graphite">{car.quickStats.year || 'N/A'}</div>
                </div>
              </div>
              <div className="bg-brand-white border border-brand-border p-6 rounded-2xl flex flex-col items-center justify-center text-center gap-3 shadow-sm hover:shadow-md transition-shadow">
                <div className="w-12 h-12 bg-brand-soft text-brand-graphite rounded-full flex items-center justify-center">
                ...
                <div>
                  ...
                  <div className="font-heading font-semibold text-brand-graphite">{car.quickStats.mileage || 'N/A'}</div>
                </div>
              </div>
              <div className="bg-brand-white border border-brand-border p-6 rounded-2xl flex flex-col items-center justify-center text-center gap-3 shadow-sm hover:shadow-md transition-shadow">
                <div className="w-12 h-12 bg-brand-soft text-brand-graphite rounded-full flex items-center justify-center">
                ...
                <div>
                  ...
                  <div className="font-heading font-semibold text-brand-graphite">{car.quickStats.fuel || 'N/A'}</div>
                </div>
              </div>
              <div className="bg-brand-white border border-brand-border p-6 rounded-2xl flex flex-col items-center justify-center text-center gap-3 shadow-sm hover:shadow-md transition-shadow">
                <div className="w-12 h-12 bg-brand-soft text-brand-graphite rounded-full flex items-center justify-center">
                ...
                <div>
                  ...
                  <div className="font-heading font-semibold text-brand-graphite">{car.quickStats.transmission || 'N/A'}</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-brand-white border border-brand-border rounded-2xl p-6 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-12">
                ...
                <div className="flex flex-col border-b border-brand-border pb-3">
                  ...
                  <span className="font-semibold text-brand-graphite">{car.specs.bodyType || 'N/A'}</span>
                </div>
                <div className="flex flex-col border-b border-brand-border pb-3">
                  <span className="text-sm text-brand-silver mb-1">Exterior Color</span>
                  <span className="font-semibold text-brand-graphite">{car.specs.exteriorColor || 'N/A'}</span>
                </div>
                
                <div className="flex flex-col border-b border-brand-border pb-3">
                  <span className="text-sm text-brand-silver mb-1">Interior Color</span>
                  <span className="font-semibold text-brand-graphite">{car.specs.interiorColor || 'N/A'}</span>
                </div>
                <div className="flex flex-col border-b border-brand-border pb-3">
                  <span className="text-sm text-brand-silver mb-1">Engine</span>
                  <span className="font-semibold text-brand-graphite">{car.specs.engine || 'N/A'}</span>
                </div>

                <div className="flex flex-col border-b border-brand-border pb-3">
                  <span className="text-sm text-brand-silver mb-1">Drive Type</span>
                  <span className="font-semibold text-brand-graphite">{car.specs.driveType || 'N/A'}</span>
                </div>
                <div className="flex flex-col border-b border-brand-border pb-3">
                  <span className="text-sm text-brand-silver mb-1">Registration Year</span>
                  <span className="font-semibold text-brand-graphite">{car.specs.registrationYear || 'N/A'}</span>
                </div>
              </div>
            </div>
